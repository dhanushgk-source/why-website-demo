...
const INITIAL_TESTIMONIALS = [
  {
    id: 'seed-1',
    name: 'Ananya Rao',
    role_or_title: 'Daughter · Singapore',
    service_type: 'Hospital Companion',
    feedback_text:
  ...
  },
  {
    id: 'seed-3',
    name: 'Priya Menon',
    role_or_title: 'Daughter · London',
    service_type: 'Travel Assistance',
    feedback_text:
  ...
  },
  {
    id: 'seed-4',
    name: 'Rahul Iyer',
    role_or_title: 'Son · Toronto',
    service_type: 'Hospital Assistance',
    feedback_text:
      "No subscriptions, no pressure — just transparent pricing and immediate updates once the visit is safely done. For someone managing this from another time zone, that simplicity matters tremendously.",
    rating: 5,
    seed: 'Rahul-Iyer',
    created_at: new Date().toISOString(),
  },
  {
    id: 'seed-5',
    name: 'Sneha Kulkarni',
    role_or_title: 'Daughter · Melbourne',
    service_type: 'Post-Op Recovery',
    feedback_text:
      "My mother recovering from surgery needed company more than anything else. Her companion sat with her, spoke Kannada with her, made her laugh. That's a service of true empathy.",
    rating: 5,
    seed: 'Sneha-Kulkarni',
    created_at: new Date().toISOString(),
  },
