...
export default function WhatsAppFloat() {
  ...
  return (
    <button
      ...
      className="group fixed bottom-6 left-5 sm:right-6 z-[9998] w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#25D366] text-white shadow-xl flex items-center justify-center hover:scale-105 active:scale-95 transition-transform duration-200"
    >
      {/* Custom floating tooltip, shown on hover/focus */}
      <span
