...
const cards = [
  { to: "/admin/jobs", emoji: "💼", title: "Manage Jobs", desc: "Create, edit and delete job postings." },
  { to: "/admin/applications", emoji: "📄", title: "Applications", desc: "View and manage candidate applications." },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f0f9fa] to-white">
      ...
      <div className="max-w-5xl mx-auto px-6 py-14">
        <div className="grid md:grid-cols-2 gap-6">
          {cards.map((c) => (
            <Link key={c.to} to={c.to} className="group bg-white rounded-2xl shadow-sm border border-gray-100 p-8 hover:shadow-xl hover:border-[#52B5BD]/40 hover:-translate-y-1 transition-all duration-300">
